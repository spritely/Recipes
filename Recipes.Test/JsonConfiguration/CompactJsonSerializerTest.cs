...
namespace Spritely.Recipes.Test
{
    ...
    public class CompactJsonSerializerTest
    {
        ...
        public void SerializeObject_without_type_serializes_to_json_using_CompactSerializerSettings()
        {
            ...
            Assert.That(json, Is.EqualTo("{\"name\":\"spud\",\"furColor\":\"brindle\",\"dogTag\":null,\"age\":5}"));
        }

        [Test]
        public void SerializeObject_with_type_serializes_to_json_using_CompactSerializerSettings()
        {
            var dog = new Dog(5, "spud", FurColor.Brindle);

            var json = CompactJsonSerializer.SerializeObject(dog, typeof(Animal));

            Assert.That(json, Is.EqualTo("{\"name\":\"spud\",\"furColor\":\"brindle\",\"dogTag\":null,\"age\":5}"));
        }

        [Test]
        public void DeserializeObject_generic_deserializes_json_using_CompactSerializerSettings()
        {
